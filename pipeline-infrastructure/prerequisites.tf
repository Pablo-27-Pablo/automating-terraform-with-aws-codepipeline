...
resource "aws_ssm_parameter" "instance_type" {
  name  = "/demo-paul-landicho/ec2/instance-type"
  type  = "String"
  value = "t2.micro"
...
resource "aws_ssm_parameter" "allowed_cidr" {
  name  = "/demo-paul-landicho/security/allowed-cidr"
  type  = "String"
...
resource "aws_ssm_parameter" "amazon_linux_ami" {
  name  = "/demo-paul-landicho/ec2/ami-id"
  type  = "String"
...
resource "aws_secretsmanager_secret" "api_key" {
  name        = "demo-paul-landicho/app/api-key"
...
resource "aws_ssm_parameter" "test_instance_type" {
  name  = "/demo-paul-landicho/test/ec2/instance-type"
  type  = "String"
  value = "t2.micro"
...
resource "aws_ssm_parameter" "prod_instance_type" {
  name  = "/demo-paul-landicho/prod/ec2/instance-type"
  type  = "String"
  value = "t2.small"
...
resource "aws_secretsmanager_secret" "test_api_key" {
  name        = "demo-paul-landicho/test/api-key"
...
resource "aws_secretsmanager_secret" "prod_api_key" {
  name        = "demo-paul-landicho/prod/api-key"
